                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h5 style="font-family: DM Sans; color:#06152B;"><b>Add New Category</h3>
                            <form class="form-inline" role="form" action="" method="post">
                                ...
                                <input required class="text-box.css" style='border: 1px solid gray; width:86%; height: 36px; border-radius:10px; font-family: DM Sans; color:#06152B;' type="text" id="category" name="category">
                                </br></br>
