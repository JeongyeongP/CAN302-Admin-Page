            ...
            <div class="container" style="border-radius:15px">
                ...
                <div class = "container" style="background-color:white; border-radius:10px">
                        <form class="form-inline" role="form" action="" method="post">
                            <h3 style="font-family: DM Sans; color:#06152B; padding-left:10px"><b>Add New Category</h3>
                            ...
                            <button type="submit" style="width:80px; margin-left:10px; border: 0px; background-color:#333333; font-family: DM Sans; color: white; font-weight: normal" class="btn btn-primary" id="add-category" name="add-category" value="add-category"> Add </button>
                            <button type="submit" style="width:80px; border: 0px; background-color:#E0E0E0; font-family: DM Sans; color: #333333; font-weight: normal" class="btn btn-primary" id="search-category" name="search-category" value="search-category"> Search</button>
                            </br></br>
                        </form>
                </div> 
